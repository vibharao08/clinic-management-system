...
<html lang="en">
    ...
    <body>
        <div style="display:flex;justify-content:center;color: white;align-items:center;">
            <div style="justify-content: center;align-items: center;">
            <h1>Univerity Visvesvaraya Collge Of Engineering</h1>
            <div style="align-items: center;text-align:center;justify-content: center;margin-left: auto;margin-right: auto;font-size: 1.5em">
            <h2>DBMS Mini Project</h2>
            <h3>Clinic Management System</h3>
            <p>Submitted by</p>
            <h3>Name: Vibha Rao H R(19GANSE055)</h3>
            </div>
            </div>
        </div>
