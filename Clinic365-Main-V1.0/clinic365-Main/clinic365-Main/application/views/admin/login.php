    ...
    <body>
        ...
        <div class="login-wrapper">
            ...
            <div class="container-center">
                ...
                <div style="justify-content: center;align-items: center;display: flex;color:white;">
                <h1>uvce</h1>
                <p>subitted by:</p>
                <h4>name:</h4>
                </div>
                        ...
                        ?>
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="type" required>
                                        ...
                                        <option value="1">Admin fuck u</option>
                                        <option value="2">fucker<?php echo display('Doctor');?></option>
