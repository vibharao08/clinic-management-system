...
<html lang="en">
    <head> 
        ...
        <link rel="icon" type="image/png" href="assets/img/favicon1.png" sizes="32x32">
    ...
    <body>
        ...
        <div class="container"> 
            ...
            <div class="row"> 
                ...
                <div class="row">
                    <div class="app_title"> 
                        <h1><img src="assets/img/icon1.png" alt="logo"> Application Installer</h1>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="alert alert-success">
                                    <strong> Application installed successfully !!!</strong>
                                </div>
